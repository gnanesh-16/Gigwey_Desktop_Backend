...
class PreciseActionRecorder:
    ...
    def __init__(
        self, 
        log_dir: str = os.path.join('C:/Users/HP/Desktop/savess', 'user_action_logs'), # Changed path
        ...
        base_dir = 'C:/Users/HP/Desktop/savess'
        if not os.path.exists(base_dir):
            os.makedirs(base_dir)
            self.logger.info(f"Created base directory: {base_dir}")
